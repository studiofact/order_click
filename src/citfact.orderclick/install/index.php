...
class citfact_orderclick extends CModule
{

    public $MODULE_ID = 'citfact.orderclick';
    ...
    public function DoInstall()
    {
        ...
        CopyDirFiles(__DIR__ . '/components/citfact', $_SERVER['DOCUMENT_ROOT'] . '/bitrix/components/citfact', true, true);
